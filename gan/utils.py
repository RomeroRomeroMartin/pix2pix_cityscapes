...
def save_sample(logger,real, generated, epoch, index, prefix='train'):
    img_folder = f'{logger.exp_name}/images/{prefix}/epoch_{epoch}'
    os.makedirs(img_folder, exist_ok=True)
    save_image(generated, os.path.join(img_folder, f'generated_{index}.png'))
    save_image(real, os.path.join(img_folder, f'real_{index}.png'))